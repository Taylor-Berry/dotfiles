...
M.toggle_inlay_hints = function()
  ...
  if vim.lsp.inlay_hint.is_enabled { bufnr = bufnr } then
    vim.lsp.inlay_hint.enable(false, { bufnr = bufnr }) -- Disable inlay hints
  else
    vim.lsp.inlay_hint.enable(true, { bufnr = bufnr }) -- Enable inlay hints
  end
end
...
function M.config()
  ...
  -- Define servers for each environment
  local servers = {}
